...
```
**Proportion of vascular plants that have been Red Listed = `r nrow(vasc_plants)/described.vasc.plants.niclughadha2016*100`**
...
**The discovery of new plants occurs at a fairly consistent rate, with a mean of `r tax.nov.year.mean` per year (1999 – 2017)**

Kew Bulletin example - look at year range 2003 - 2017 (2003 onwards as this is when 3.1 assessments first came in for plants). How many have been red listed?
...
**Of the 1,234 newly described taxa published in Kew Bulletin from 2003–2017, only `r nrow(KewBull_tax.nov)` `r nrow(KB_RL_joined)/nrow(KewBull_tax.nov)*100` are currently on the Red List**


What is ratio of old (>5 years) and new (<=5 years) assessments for each red list publicaiton year (Figure 2). 
