...
This document describes methods used in the paper **'Progress, challenges and opportunities for plant Red Listing'**. Each numbered section relates to numbered sections in the manuscript. See section [04_outputs](../blob/master/04_outputs) for the manuscript.
...
**Proportion of vertebrates described that have been Red Listed = `r round((prop.nonverts.RL * 100), digits = 2) `**
...
A query was made for each year, with a filter on 'Specific' taxa (species). A csv for each year from 1999 - 2017 inclusive was downloaded. See 01_data folder
